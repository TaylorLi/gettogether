...
public partial class WebService_Callback_Projects : GetTogether.Studio.Web.UI.PageCallback
{
    ...
    {
        Control c = Page.LoadControl("~/WebService/Components/ProjectGroup.ascx");
        Page.Controls.Add(c);
    }
