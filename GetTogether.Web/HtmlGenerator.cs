...
namespace GetTogether.Web
{
    public class HtmlGenerator
    {
        ...
        public static string GetWebsiteLink(string website, string defaultStr)
        {
            if (string.IsNullOrEmpty(website)) return defaultStr;
            return string.Concat("<a target='_blank' href='", website, "'>", website, "</a>");
        }
    }
}
