...
{
    public class PageOnlineUser : PageAdmin
    {
        ...
        protected override void OnPreLoad(EventArgs e)
        {
            ...
            {
                Response.Clear();
                Response.Write(GetTogether.Utility.SerializationHelper.SerializeToXml(GetOnlineUsers(PageIndex, PageSize, Sort, IsAsc)));
            }
            else if (type == 1)
            {
        ...
        {
            OnlineUserManager.OnlineUsers users = new OnlineUserManager.OnlineUsers();
            Web.SimultaneousLogin.LoginInformationList list = SimultaneousLogin.GetLoginInformationList(this.Page);
            Web.SimultaneousLogin.LoginInformationList list_result = new SimultaneousLogin.LoginInformationList();
            ...
            {
                foreach (Web.SimultaneousLogin.LoginInformation li in list)
                {
