...
namespace GetTogether.Web
{
    public class SimultaneousLogin
    {
        public class LoginInformation
        {
            ...
            private string _OperationSystem = System.Web.HttpContext.Current.Request["os"];
            ...
            public LoginInformation(string companyCode, string userCode, string email, string userName)
            {
                ...
                if (string.IsNullOrEmpty(this.OperationSystem))
                {
                    this.OperationSystem = "Unknown";
                }
                ci.OperationSystem = this.OperationSystem;
                ClientInformation.SetClientInformation(ci);
            }
        }
        ...
        public static void ValidateOnSessionEnd(System.Web.HttpApplicationState app, System.Web.SessionState.HttpSessionState sess)
        {
            ...
            if (hOnline != null && hOnline.ContainsKey(sess.SessionID) && hOnline[sess.SessionID] != null)
            {
