...
namespace GetTogether.ObjectBase
{
        ...
        where T : class, new()
    {
        ...
        //        return Web.TableHelper.GenListToTable(this, null, null, null, false, merge_columns);
        //    return null;
        //}
        ...
        //{
        //    if (this != null && this.Count > 0)
        //        return Web.TableHelper.GenListToTable(this, table_css, header_css, rows_css, false, merge_columns);
        //    return null;
        //}
        ...
        //{
        //    if (this != null && this.Count > 0)
        //        return Web.TableHelper.GenListToTable(this, null, null, null, merge_all_columns);
        //    return null;
        //}
        ...
        public List<O> FieldValuesToList<O>(string fieldName)
        {
            ...
            foreach (T t in this)
            {
                ret.Add((O)GetTogether.Mapping.ObjectHelper.GetValue<T>(t, fieldName));
            }
            return ret;
        }
        ...
        public C Search<C, V>(string column, V v) where C : ICollection<T>, new()
        {
            ...
            PredicateHelper<V> ph = null;
            if (caches.ContainsKey(key)) ph = caches[key] as PredicateHelper<V>;
            if (ph == null)
            {
