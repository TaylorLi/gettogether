    ...
    public static class SqlScriptHandler
    {
        ...
        public static string GetCondition(ParameterCollection pc, bool isAppend)
        {
            ...
            foreach (Parameter p in ProcessColumnPars(pc))
            {
                ...
                if (p.TokType == GetTogether.Data.TokenTypes.IsNotNull || p.TokType == GetTogether.Data.TokenTypes.IsNull || p.TokType == TokenTypes.In || p.TokType == TokenTypes.NotIn) continue;
        ...
        public static string GetConditionsFromParameterCollection(ParameterCollection pc)
        {
            if (pc == null || pc.Count == 0) return string.Empty;
            pc[0].ParType = ParameterType.Initial;
            StringBuilder sbParameters = new StringBuilder();
        ...
        public static class Search
        {
            ...
            public const string SelectIdentityId = "select @@identity";
            public const string InitiallySelectString = "select {0}{1} from `{2}`";
