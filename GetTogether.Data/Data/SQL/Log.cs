...
namespace GetTogether.Data.SQL
{
    public class Log
    {
        ...
        {
            if (EnableLog && Config.Log.LogInfo) Data.Log.WriteInfo(Config.Log.Logger.Info, string.Concat(GetTogether.Data.DatabaseType.SQLServer, ":\r\n", l));
        }

        public static void StoredProcedure(string l)
        {
            if (EnableLog && Config.Log.LogStoredProcedure) Data.Log.WriteInfo(Config.Log.Logger.StoredProcedure, string.Concat(GetTogether.Data.DatabaseType.SQLServer, ":\r\n", l));
        }

        public static void Warning(string l)
        {
            if (EnableLog && Config.Log.LogWarning) Data.Log.WriteWarn(Config.Log.Logger.Warning, string.Concat(GetTogether.Data.DatabaseType.SQLServer, ":\r\n", l));
        }

        public static void Debug(string l)
        {
            if (EnableLog && Config.Log.LogDebug) Data.Log.WriteInfo(Config.Log.Logger.Debug, string.Concat(GetTogether.Data.DatabaseType.SQLServer, ":\r\n", l));
        }

        public static void Insert(string l)
        {
            if (EnableLog && Config.Log.LogInsert) Data.Log.WriteInfo(Config.Log.Logger.Insert, string.Concat(GetTogether.Data.DatabaseType.SQLServer, ":\r\n", l));
        }

        public static void Select(string l)
        {
            if (EnableLog && Config.Log.LogSelect) Data.Log.WriteInfo(Config.Log.Logger.Select, string.Concat(GetTogether.Data.DatabaseType.SQLServer, ":\r\n", l));
        }

        public static void Update(string l)
        {
            if (EnableLog && Config.Log.LogUpdate) Data.Log.WriteInfo(Config.Log.Logger.Update, string.Concat(GetTogether.Data.DatabaseType.SQLServer, ":\r\n", l));
        }

        public static void Delete(string l)
        {
            if (EnableLog && Config.Log.LogDelete) Data.Log.WriteInfo(Config.Log.Logger.Delete, string.Concat(GetTogether.Data.DatabaseType.SQLServer, ":\r\n", l));
        }
    }
}
